...
<Button
  ...
  class={`justify-center border-0 bg-[#5865F2]/10 text-sm text-[#4752C4] hover:bg-[#5865F2]/18 hover:text-[#3F49B7] dark:bg-[#5865F2]/20 dark:text-[#7B86F8] dark:hover:bg-[#5865F2]/30 dark:hover:text-[#A0A8FF] ${className}`.trim()}
>
