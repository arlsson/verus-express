export const en: Record<string, string> = {
  ...
  'wallet.settings.recovery.description':
    'Access recovery secrets for this profile after confirming your password.',
  'wallet.settings.recovery.lockedDescription':
    'Recovery secrets are hidden until you verify your wallet password.',
  ...
  'wallet.settings.recovery.warningTitle': 'Reveal sensitive secrets?',
  'wallet.settings.recovery.warningDescription':
    'The next step can reveal your seed and private keys in plain text.',
  'wallet.settings.recovery.warningContinue': 'I understand, continue',
  'wallet.settings.recovery.passwordTitle': 'Confirm your password',
  'wallet.settings.recovery.passwordDescription':
    'Enter your wallet password to reveal recovery secrets for this session.',
  ...
  'wallet.assetDetails.totalLoaded': 'Total across loaded scopes: {value}',
  'wallet.assetDetails.address': 'Address',
  'wallet.assetDetails.chain': 'Network',
  'wallet.assetDetails.scopePicker': 'Change address and network',
  'wallet.assetDetails.changeAddress': 'Change',
  'wallet.assetDetails.primaryAddress': 'Primary address',
  'wallet.assetDetails.readOnlyAddress': 'Read-only address',
  ...
  'wallet.identity.title': 'Identities',
  ...
  'wallet.identity.list.description': '{count} linked identities',
