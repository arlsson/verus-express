export const en: Record<string, string> = {
  ...
  'guard.flow.secret.inputPlaceholder': 'Paste seed phrase, WIF, or private key hex',
  'guard.flow.secret.inputHelp': 'This key stays in memory for this temporary guard session only.',
  ...
  'guard.flow.target.description': 'Enter the VerusID you want to {action}.',
  'guard.flow.target.identityLabel': 'Target VerusID',
  ...
  'guard.flow.target.primaryLabel': 'New primary address',
  ...
  'guard.flow.target.preflightBusy': 'Preparing review…',
  'guard.flow.target.lookupBusy': 'Checking VerusID…',
  ...
  'guard.flow.patch.continueBusy': 'Preparing review…',
  ...
  'help.keepSafe.phoneQuestion': 'What happens if I switch or lose my phone?',
