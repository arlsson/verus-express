export const en: Record<string, string> = {
  ...
  'wallet.addAsset.error.manualInputRequired': 'Enter a PBaaS currency name, i-address, or ERC20 contract address.',
  ...
  'wallet.transfer.step.review.description': 'Check fees, route details, and warnings before broadcast.',
  ...
  'wallet.transfer.sourceBalance': 'Spendable balance: {value}',
  'wallet.transfer.sourceChannel': 'Channel: {value}',
  'wallet.transfer.sourceSheetOpen': 'Source details',
  'wallet.transfer.sourceSheetTitle': 'Source details',
  ...
  'wallet.transfer.convertUnavailableEvm': 'Convert is not available for this source yet. You can continue with send.',
  ...
  'wallet.transfer.error.bridgeNotImplemented': 'This conversion route is not available on desktop yet.',
