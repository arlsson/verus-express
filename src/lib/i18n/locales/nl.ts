export const nl: Record<string, string> = {
  ...
  'guard.flow.target.description': 'Voer de VerusID in die je wilt {action}.',
  ...
  'guard.flow.target.preflightBusy': 'Review voorbereiden…',
  'guard.flow.target.lookupBusy': 'VerusID controleren…',
  ...
  'guard.flow.patch.continueBusy': 'Review voorbereiden…',
  ...
  'help.keepSafe.phoneQuestion': 'Wat gebeurt er als ik van telefoon wissel of hem verlies?',
